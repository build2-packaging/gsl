...
TEST_CASE("utils_tests, finally_const_lvalue_lambda")
{
    int i = 0;
    {
...
TEST_CASE("utils_tests, finally_mutable_lvalue_lambda")
{
    int i = 0;
    {
...
TEST_CASE("utils_tests, finally_function")
{
    j = 0;
    {
        auto _ = finally(g);
