...
TEST_CASE("notnull_tests, TestNotNullConstructors")
{
    {
...
TEST_CASE("notnull_tests, TestNotNullostream")
{
...
TEST_CASE("notnull_tests, TestNotNullCasting")
{
    MyBase base;
    MyDerived derived;
    Unrelated unrelated;
...
TEST_CASE("notnull_tests, TestNotNullAssignment")
{
    const auto terminateHandler = std::set_terminate([] {
...
TEST_CASE("notnull_tests, TestNotNullRawPointerComparison")
{
    int ints[2] = {42, 43};
    int* p1 = &ints[0];
    const int* p2 = &ints[1];
...
TEST_CASE("notnull_tests, TestNotNullDereferenceOperator")
{
    {
...
TEST_CASE("notnull_tests, TestNotNullSharedPtrComparison")
{
...
TEST_CASE("notnull_tests, TestNotNullCustomPtrComparison")
{
    int ints[2] = {42, 43};
    CustomPtr<int> p1(&ints[0]);
...
TEST_CASE("notnull_tests, TestNotNullConstructorTypeDeduction")
{
    {
        int i = 42;
...
TEST_CASE("notnull_tests, TestMakeNotNull")
{
    {
        int i = 42;
...
TEST_CASE("notnull_tests, TestStdHash")
{
    {
        int x = 42;
        int y = 99;
        ...
        CHECK(hash_nn(nn) == hash_intptr(&x));
        CHECK(hash_nn(nn) != hash_intptr(&y));
        CHECK(hash_nn(nn) != hash_intptr(nullptr));
    }
