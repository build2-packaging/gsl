...
TEST_CASE("algorithm_tests, same_type") {
...
TEST_CASE("algorithm_tests, compatible_type") {
  // dynamic source and destination span
  {
...
TEST_CASE("algorithm_tests, incompatible_type") {
...
// TEST_CASE("algorithm_tests, small_destination_span") {
//   std::set_terminate([] {
