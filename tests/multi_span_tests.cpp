...
TEST_CASE("multi_span_test, default_constructor") {
  {
    multi_span<int> s;
    CHECK(s.length() == 0);
...
TEST_CASE("multi_span_test, from_nullptr_constructor") {
  {
...
TEST_CASE("multi_span_test, from_nullptr_length_constructor") {
  {
...
TEST_CASE("multi_span_test, from_element_constructor") {
  int i = 5;
...
TEST_CASE("multi_span_test, from_pointer_length_constructor") {
  int arr[4] = {1, 2, 3, 4};
...
TEST_CASE("multi_span_test, from_pointer_pointer_constructor") {
  int arr[4] = {1, 2, 3, 4};
...
TEST_CASE("multi_span_test, from_array_constructor") {
  int arr[5] = {1, 2, 3, 4, 5};
...
TEST_CASE("multi_span_test, from_dynamic_array_constructor") {
...
TEST_CASE("multi_span_test, from_std_array_constructor") {
...
TEST_CASE("multi_span_test, from_const_std_array_constructor") {
...
TEST_CASE("multi_span_test, from_container_constructor") {
...
TEST_CASE("multi_span_test, from_convertible_span_constructor") {
#ifdef CONFIRM_COMPILATION_ERRORS
...
TEST_CASE("multi_span_test, copy_move_and_assignment") {
  multi_span<int> s1;
  CHECK(s1.empty());
...
TEST_CASE("multi_span_test, as_multi_span_reshape") {
  int a[3][4][5];
...
TEST_CASE("multi_span_test, first") {
  int arr[5] = {1, 2, 3, 4, 5};
...
TEST_CASE("multi_span_test, last") {
  int arr[5] = {1, 2, 3, 4, 5};
...
TEST_CASE("multi_span_test, subspan") {
  int arr[5] = {1, 2, 3, 4, 5};
...

  {
    ...
    // Disabled TEST_CASE "instead of fixing" since multi_span is deprecated.
    // (PR#835)
...
TEST_CASE("multi_span_test, rank") {
  int arr[2] = {1, 2};

  {
    multi_span<int> s;
    CHECK(s.rank() == static_cast<size_t>(1));
  }
  ...
  int arr2d[1][1] = {};
  {
    ...
    CHECK(s.rank() == static_cast<size_t>(2));
  }
}

TEST_CASE("multi_span_test, extent") {
  std::set_terminate([] {
...
TEST_CASE("multi_span_test, operator_function_call") {
  int arr[4] = {1, 2, 3, 4};
...
TEST_CASE("multi_span_test, comparison_operators") {
  {
    int arr[10][2];
...
TEST_CASE("multi_span_test, basics") {
...
TEST_CASE("multi_span_test, bounds_checks") {
  int arr[10][2];
...
TEST_CASE("multi_span_test, span_parameter_test") {
...
TEST_CASE("multi_span_test, md_access") {
  ...
  auto image_view = as_multi_span(as_multi_span(image_ptr, imgSize),
                                  dim(height), dim(width), dim<3>());
...
TEST_CASE("multi_span_test, as_multi_span") {
  {
    int* arr = new int[150];
...
TEST_CASE("multi_span_test, empty_spans") {
  std::set_terminate([] {
...
TEST_CASE("multi_span_test, index_constructor") {
  auto arr = new int[8];
  for (int i = 0; i < 4; ++i) {
    arr[2 * i] = 4 + i;
    arr[2 * i + 1] = i;
...
TEST_CASE("multi_span_test, index_constructors"){
...
TEST_CASE("multi_span_test, index_operations") {
  ptrdiff_t a[3] = {0, 1, 2};
  ptrdiff_t b[3] = {3, 4, 5};
...
TEST_CASE("multi_span_test, span_section_iteration") {
...
TEST_CASE("multi_span_test, dynamic_span_section_iteration") {
...
TEST_CASE("multi_span_test, span_structure_size") {
  double(*arr)[3][4] = new double[100][3][4];
...
TEST_CASE("multi_span_test, fixed_size_conversions") {
  int arr[] = {1, 2, 3, 4};
...
TEST_CASE("multi_span_test, as_writeable_bytes") {
  int a[] = {1, 2, 3, 4};
...
TEST_CASE("multi_span_test, iterator") {
  int a[] = {1, 2, 3, 4};
